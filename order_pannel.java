...
public class order_pannel extends javax.swing.JFrame {
  Connection con=null;
 ...
 ResultSet rs=null;
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Bill_code", "TYPE", "Name", "Date", "state", "pin_no", "price"
            }
        ));
  ...
  model.removeRow(0);
   ...
   con=(Connection) DriverManager.getConnection("jdbc:mysql://localhost:3306/restaurant?zeroDateTimeBehavior=convertToNull","root","");
       try (Statement stmt = con.createStatement()) {
          ...
          try (ResultSet RS7 = stmt.executeQuery(query)) {
              while(RS7.next())
              {
                  model.addRow (new Object[] {RS7.getString("Billno"),RS7.getString("customer_type"),RS7.getString("name"),RS7.getString("date"),RS7.getString("item_name"),RS7.getString("quantity"),RS7.getString("amount"),RS7.getString("discount"),RS7.getString("netamount")});
              }
          }
       }
     con.close();
  ...
  catch(ClassNotFoundException | IllegalAccessException | InstantiationException | SQLException e)
  {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(order_pannel.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        }
      //</editor-fold>
      //</editor-fold>
      //</editor-fold>
      //</editor-fold>
        ...
        java.awt.EventQueue.invokeLater(() -> {
            new order_pannel().setVisible(true); 
        });
    }
