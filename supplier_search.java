...
public class supplier_search extends javax.swing.JFrame {
 ...
 ResultSet rs=null;
    ...
    private void initComponents() {
        ...
        jLabel7.setText("Enter id of the supplier  you want to search     :");
        p1.add(jLabel7);
        ...
        jLabel2.setText("SUPPLIER  SEARCH");
        p1.add(jLabel2);
        ...
        jLabel3.setText("Enter name of the supplier you want to search :");
        p1.add(jLabel3);
        jLabel3.setBounds(130, 170, 1016, 58);
   ...
   Class.forName("com.mysql.jdbc.Driver").newInstance();
    ...
    con=(Connection) DriverManager.getConnection("jdbc:mysql://localhost:3306/restaurant?zeroDateTimeBehavior=convertToNull","root","");
     try (Statement stmt = con.createStatement()) {
         String query = "SELECT * FROM item4 where supplier_name = '"+me+"';";
       try (ResultSet rs76 = stmt.executeQuery(query)) {
           while(rs76.next())
           {
               model.addRow (new Object[] {rs76.getString("supplier_code"),rs76.getString("supplier_name"),rs76.getString("address"),rs76.getString("city"),rs76.getString("state"),rs76.getString("pin_no"),rs76.getString("phone_no")});
           }
       }
     }
     con.close();
      ...
      for(int mh  = 0 ; mh <= ml ; ++mh)
{
  model.removeRow(0);
   ...
   Class.forName("com.mysql.jdbc.Driver").newInstance();
    ...
    con=(Connection) DriverManager.getConnection("jdbc:mysql://localhost:3306/restaurant?zeroDateTimeBehavior=convertToNull","root","");
     try (Statement stmt = con.createStatement()) {
         String query = "SELECT * FROM item4 where supplier_code = '"+me+"';";
       try (ResultSet rs76 = stmt.executeQuery(query)) {
           while(rs76.next())
           {
               model.addRow (new Object[] {rs76.getString("supplier_code"),rs76.getString("supplier_name"),rs76.getString("address"),rs76.getString("city"),rs76.getString("state"),rs76.getString("pin_no"),rs76.getString("phone_no")});
