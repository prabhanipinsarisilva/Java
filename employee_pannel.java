...
public class employee_pannel extends javax.swing.JFrame {
 ...
 ResultSet rs=null;
    ...
    private void initComponents() {
        ...
        p1.add(jPanel4);
        jPanel4.setBounds(40, 27, 1342, 514);
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "employee_code", "employee_name", "address", "city", "state", "pin_no", "phone_no"
            }
        ));
        ...
        p1.add(jPanel5);
        jPanel5.setBounds(40, 550, 1342, 255);
        ...
        p1.add(jButton10);
        jButton10.setBounds(637, 831, 300, 58);

        jLabel6.setIcon(new javax.swing.ImageIcon(getClass().getResource("/splashscr/images/Breakfast-food-Backgrounds.jpg"))); // NOI18N
        p1.add(jLabel6);
        jLabel6.setBounds(-10, 0, 1790, 950);
        ...
        jLabel5.setText("DELETE EMPLYEE DATA");
        ...
        jLabel16.setText("EMPLOYEE DATA update");

        jLabel17.setText("Employee code  :");
   ...
   //  Connection con = (Connection)DriverManager.getConnection("jdbc:mysql://localhost:3306/restaurant?zeroDateTimeBehavior=convertToNull","root","netbean");
    con=(Connection) DriverManager.getConnection("jdbc:mysql://localhost:3306/restaurant?zeroDateTimeBehavior=convertToNull","root","");
            try (Statement stmt1 = con.createStatement()) {
                String query = "SELECT * FROM item5 ;";
          try (ResultSet rs1 = stmt1.executeQuery(query)) {
              while(rs1.next())
              {
                  model.addRow (new Object[] {rs1.getString("employee_code"),rs1.getString("employee_name"),rs1.getString("address"),rs1.getString("city"),rs1.getString("state"),rs1.getString("pin_no"),rs1.getString("phone_no")});
              }
          }
            }
     con.close();
...
try{
    ...
    try (Statement stmt2 = con.createStatement()) {
        ...
        if(bp == JOptionPane.YES_OPTION){
            ...
            String query = "Delete from item5 where employee_code = '"+ml+"';";
   ...
   //  Connection con = (Connection)DriverManager.getConnection("jdbc:mysql://localhost:3306/restaurant?zeroDateTimeBehavior=convertToNull","root","netbean");
    con=(Connection) DriverManager.getConnection("jdbc:mysql://localhost:3306/restaurant?zeroDateTimeBehavior=convertToNull","root","");
          ...
          try (ResultSet rs3 = stmt3.executeQuery(query)) {
              while(rs3.next())
              {
                  model.addRow (new Object[] {rs3.getString("employee_code"),rs3.getString("employee_name"),rs3.getString("address"),rs3.getString("city"),rs3.getString("state"),rs3.getString("pin_no"),rs3.getString("phone_no")});
              }
          }
            }
     con.close();
  ...
  try{
    ...
    con=(Connection) DriverManager.getConnection("jdbc:mysql://localhost:3306/restaurant?zeroDateTimeBehavior=convertToNull","root","");
       try (Statement stmt = con.createStatement()) {
           ...
           if(bp == JOptionPane.YES_OPTION){
               String query = "update item5 set employee_name = '"+ ml +"', address = '" + mj+"', city = '"+ md+"', state = '"+ mt+"', pin_no = '"+ mm +"', phone_no = '"+ mn+"'where employee_code = '"+ mk +"';";
               stmt.execute(query);
  ...
  catch(ClassNotFoundException | IllegalAccessException | InstantiationException | SQLException e)
  {
    ...
    private void pp4mouseclicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_pp4mouseclicked
        // TODO add your handling code here:
         ...
         employee_search  A=new   employee_search();
          this.setVisible(false);
           A.setVisible(true);
