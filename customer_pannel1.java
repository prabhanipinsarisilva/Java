...
public class customer_pannel1 extends javax.swing.JFrame {
  Connection con=null;
 ...
 ResultSet rs=null;
    ...
    private void initComponents() {
        ...
        pp4.setBackground(new java.awt.Color(255, 0, 51));
        ...
        jLabel15.setText("Enter customer code whose Data you want to delete  :");
        ...
        jLabel16.setText("CUSTOMER DATA update");

        jLabel17.setText("Customer code  :");
   ...
   //  Connection con = (Connection)DriverManager.getConnection("jdbc:mysql://localhost:3306/restaurant?zeroDateTimeBehavior=convertToNull","root","netbean");
    con=(Connection) DriverManager.getConnection("jdbc:mysql://localhost:3306/restaurant?zeroDateTimeBehavior=convertToNull","root","");
          ...
          try (ResultSet rs1 = stmt1.executeQuery(query)) {
              while(rs1.next())
              {
                  model.addRow (new Object[] {rs1.getString("customer_code"),rs1.getString("customer_name"),rs1.getString("address"),rs1.getString("city"),rs1.getString("state"),rs1.getString("pin_no"),rs1.getString("phone_no")});
              }
          }
            }
     con.close();
   ...
   //  Connection con = (Connection)DriverManager.getConnection("jdbc:mysql://localhost:3306/restaurant?zeroDateTimeBehavior=convertToNull","root","netbean");
    con=(Connection) DriverManager.getConnection("jdbc:mysql://localhost:3306/restaurant?zeroDateTimeBehavior=convertToNull","root","");
          ...
          try (ResultSet rs3 = stmt3.executeQuery(query)) {
              while(rs3.next())
              {
                  model.addRow (new Object[] {rs3.getString("customer_code"),rs3.getString("customer_name"),rs3.getString("address"),rs3.getString("city"),rs3.getString("state"),rs3.getString("pin_no"),rs3.getString("phone_no")});
              }
          }
            }
     con.close();
      ...
      for(int lu  = 0 ; lu <= ll ; ++lu)
{
  ...
  // TODO add your handling code here:
    ...
    private void pp4mouseclicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_pp4mouseclicked
        // TODO add your handling code here:
        customer_search11 A=new  customer_search11();
          this.setVisible(false);
           A.setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(customer_pannel1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        }
      //</editor-fold>
      //</editor-fold>
      //</editor-fold>
      //</editor-fold>
        ...
        java.awt.EventQueue.invokeLater(() -> {
            new customer_pannel1().setVisible(true); 
        });
    }
